...
/** onlineMakeGenerator POST /api/generator/make */
export async function onlineMakeGeneratorUsingPost(
...
/** onlineUseGenerator POST /api/generator/use */
export async function onlineUseGeneratorUsingPost(
